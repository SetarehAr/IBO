...
def evaluate_error_model(X_tr_loc, Y_tr_loc, X_val, Y_val, params):
    ...
    nb_epochs = 2
    model.fit(X_tr_loc, Y_tr_loc,batch_size=batchsize,epochs=nb_epochs,verbose=1, validation_data=(X_val, Y_val)) 
...
def objective_function(params, s):
    ...
    y = evaluate_error_model(train_subset,
        train_targets_subset , X_test, Y_test, params)
