...
def objective_function(param,B):
    ...
    # Train the model
    ImportanceTraining(model, presample=float(B)).fit(x_train,y_train,batch_size=batch_size,epochs=nb_epochs,validation_data=(x_test, y_test), verbose=1)
